    ...
    spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Soneet Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle *networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Soneet address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and soneet: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Soneet Core"), this);
    aboutAction->setStatusTip(tr("Show information about Soneet Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Soneet"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Soneet addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Soneet addresses"));
    ...
    openAction->setStatusTip(tr("Open a soneet: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Soneet Core help message to get a list with possible Soneet command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Soneet Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Soneet network", "", count));
}
...
{
    QString strTitle = tr("Soneet Core"); // default title
