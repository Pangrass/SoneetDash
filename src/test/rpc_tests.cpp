...
BOOST_AUTO_TEST_CASE(rpc_format_monetary_values)
{
    ...
    BOOST_CHECK_EQUAL(write_string(ValueFromAmount(2029012901290190LL), false), "20290199.29019990");
    BOOST_CHECK_EQUAL(write_string(ValueFromAmount(2029012901290199LL), false), "20290199.29012901");
}
...
BOOST_AUTO_TEST_CASE(rpc_parse_monetary_values)
{
    ...
    BOOST_CHECK_EQUAL(AmountFromValue(ValueFromString("20290199.2901999")), 2029012901290190LL);
    BOOST_CHECK_EQUAL(AmountFromValue(ValueFromString("20290199.29012901")), 2029012901290199LL);
}
