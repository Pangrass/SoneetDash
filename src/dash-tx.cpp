...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Soneet Core soneet-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  soneet-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded soneet transaction") + "\n" +
              "  soneet-tx [options] -create [commands]   " + _("Create hex-encoded soneet transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded soneet transaction
