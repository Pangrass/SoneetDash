...
/* *** BEGIN DARKSEND MAGIC - SONEET **********
    Copyright (c) 2014-2015, Soneet Developers
        eduffield - evan@soneet.io
        udjinm6   - udjinm6@soneet.io
*/
    ...
    if(fMasterNode) {
        ...
        BOOST_FOREACH(const CTransaction& txCollateral, vecSessionCollateral) {
            ...
            /*
                ...
                allow endless transaction that would bloat Soneet and make it unusable. To
...
bool CDarksendPool::DoAutomaticDenominating(bool fDryRun)
{
    ...
    if (!pwalletMain->SelectCoinsDark(nValueMin, nBalanceNeedsAnonymized, vCoins, nValueIn, 0, nDarksendRounds))
    {
        ...
        if (pwalletMain->SelectCoinsDark(nValueMin, 2901999*COIN, vCoins, nValueIn, -2, 0))
        {
