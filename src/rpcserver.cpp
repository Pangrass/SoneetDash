...
{ //  category              name                      actor (function)         okSafeMode threadSafe reqWallet
  //  --------------------- ------------------------  -----------------------  ---------- ---------- ---------
    ...
    /* Soneet features */
    { "soneet",               "masternode",             &masternode,             true,      true,       false },
    { "soneet",               "masternodelist",         &masternodelist,         true,      true,       false },
    { "soneet",               "masternodebroadcast",    &masternodebroadcast,    true,      true,       false },
    { "soneet",               "mnbudget",               &mnbudget,               true,      true,       false },
    { "soneet",               "mnbudgetvoteraw",        &mnbudgetvoteraw,        true,      true,       false },
    { "soneet",               "mnfinalbudget",          &mnfinalbudget,          true,      true,       false },
    { "soneet",               "mnsync",                 &mnsync,                 true,      true,       false },
    { "soneet",               "spork",                  &spork,                  true,      true,       false },
#ifdef ENABLE_WALLET
    { "soneet",               "darksend",               &darksend,               false,     false,      true  }, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
         ...
         (mapArgs["-rpcuser"] == mapArgs["-rpcpassword"])) && Params().RequireRPCPassword())
    {
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
            _("To use soneetd, or the -server option to soneet-qt, you must set an rpcpassword in the configuration file:\n"
              "%s\n"
...
std::string HelpExampleCli(string methodname, string args){
    return "> soneet-cli " + methodname + " " + args + "\n";
}

std::string HelpExampleRpc(string methodname, string args){
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
        "\"method\": \"" + methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:2904/\n";
}
